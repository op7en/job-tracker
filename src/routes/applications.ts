...
import { ApplicationSchema, StatusSchema, UpdateApplicationSchema } from "../schemas/authSchema";
...
router.patch("/:id", validate(UpdateApplicationSchema), appController.updateFields);
